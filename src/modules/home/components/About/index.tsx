		...
		<BlockContainer innerClassName={s.container} anchor="about">
			...
			<div className={s.inner}>
				<article className={s.intro}>
					<BlockTitle
						title="Простір, де навчання стає пригодою"
						highlightCount={2}
					/>
					<p>
						Київський ліцей авіаційних та інформаційних технологій - це сучасна
						приватна школа початкової освіти в центрі Києва, де дитина почувається в
						безпеці, відчуває підтримку й отримує справжнє задоволення від навчання.
					</p>
				</article>
